                ...
                <div class="flex-grow overflow-auto">
                    <table class="relative w-full border rounded-3xl">
                        ...
                        <tbody class="divide-y divide-gray-300 bg-gray-100">
                            <tr>
                                <td class="px-6 py-4 text-center">asdad</td>
                                <td class="px-6 py-4 text-center">asdad</td>
                                <td class="px-6 py-4 text-center">asdad</td>
                                <td class="flex items-center justify-center px-6 py-4 text-center">
                                    <button name="selected" type="submit" class="w-8 h-8 focus:outline-none rounded-full bg-red-500 hover:bg-red-600 hover:shadow-lg">
                ...
                <div class="flex-grow overflow-auto">
                        <table class="relative w-full border rounded-3xl">
                            ...
                            <tbody class="divide-y divide-gray-300 bg-gray-100">
                                <tr>
                                    <td class="px-6 py-4 text-center">asdad</td>
                                    <td class="px-6 py-4 text-center">asdasd</td>
                                    <td class="px-6 py-4 text-center">asdasd</td>
                                    <td class="flex items-center justify-center px-6 py-4 text-center">
                                        <button name="selected" type="submit" class="w-8 h-8 focus:outline-none rounded-full bg-green-400 hover:bg-green-500 hover:shadow-lg">
                                            <span class="flex items-center justify-center text-white">
                                                <svg class="h-6 w-6"
                                                    fill="none"
                                                    viewBox="0 0 24 24"
