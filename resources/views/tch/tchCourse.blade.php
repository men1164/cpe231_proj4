...
@section('content')
    <div class="flex justify-center items-center ml-60 h-full bg-gray-200 p-8">
        <div class="w-5/6 h-5/6 bg-white rounded-xl shadow-xl">
            <p class="ml-12 mt-12 text-5xl font-semibold text-darkblue2">Classes</p>
            <p class="ml-14 mt-2 text-xl text-black">Classes under your responsibility.</p>
            @if($results->count() != 0)
                    ...
                    <table class="relative w-full border rounded-3xl">
                        <thead>
                            <tr>
                                ...
                                <th class="sticky top-0 px-6 py-3 text-green-400 bg-white">Enrolled students</th>
                            </tr>
                        </thead>
