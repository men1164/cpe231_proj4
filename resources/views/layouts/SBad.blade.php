    ...
    <body>
        ...
        <div class="h-full w-60 p-4 bg-white shadow-xl fixed">
            <ul class="flex flex-col w-full">
                ...
                <li>
                    <a href="{{ route('admin.regisManage') }}"
                    class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-500 hover:bg-gray-100">
                        ...
                        <span class="ml-3">Register Manager</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    ...
                    class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-500 hover:bg-gray-100">
                        ...
                        <span class="ml-3">Course's Teacher</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('admin.classAnalysis') }}"
                    class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-500 hover:bg-gray-100">
                        <span class="flex items-center justify-center text-lg text-darkblue2">
                            <svg class="h-6 w-6" 
                                fill="none" 
                        ...
                        <span class="ml-3">Class Analysis</span>
                    </a>
                </li>
                <li>
