    ...
    <body>
        <div class="grid place-items-center bg-gray-200 h-full">
            <div class="flex flex-col items-center justify-center bg-white w-4/5 h-2/5 rounded-2xl shadow-2xl">
                <p class="text-6xl text-darkblue2">Welcome to Student Registration</p>
                <p class="text-2xl text-black mt-10">Please choose your role.</p>
                <div class="flex flex-row justify-center items-center mt-10 w-4/5">
                    ...
                    <a href="{{ route('register') }}" class="w-2/5 focus:outline-none text-white text-center text-sm rounded-full py-3 px-6 ml-10 bg-kmutt-or hover:bg-kmutt-hover hover:shadow-lg">Student Register</a>     
                </div>              
            </div>
        </div>
    </body>
